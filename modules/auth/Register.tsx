...
// Eliminado: import { KeyboardAwareScrollView } from "react-native-keyboard-aware-scroll-view";
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          ...
          <View>
              ...
              <Controller
                ...
                rules={{
                  ...
                  pattern: {
                    ...
                    message:
                      "Debe incluir una mayúscula, número y carácter especial",
                  },
                }}
                render={({ field: { onChange, onBlur, value } }) => (
                  <TextInput
            ...
            {errors.contraseia && (
              <Text style={{ color: "red" }}>{errors.contraseia.message}</Text>
            )}
